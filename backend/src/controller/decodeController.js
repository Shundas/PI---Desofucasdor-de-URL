    ...
    manipulaArquivo(request, response) {
        ...
        async function processFile(file) {
            ...
            readInterface.on('line', (line) => {
                ...
                line = line.replace(regexPercent, function (n) { return hashMap.htmlEntitiesPer[n] })
                line = line.replace(regexChar, function (n) { return hashMap.htmlEntitiesChar[n] })
                line = line.replace(regexAmpersan, function (n) { return hashMap.htmlEntitiesAmp[n] })
                line = line.replace(regexHexaChar, function (n) { return hashMap.hexaChar[n] })
