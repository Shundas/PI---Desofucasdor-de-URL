...
module.exports = {
    manipulaArquivo(request, response) {
        ...
        async function processFile(file) {
            ...
            readInterface.on('line', (line) => {
                ...
                line = line.replace(regexPercent, function (n) { return htmlEntitiesPer[n] })
                line = line.replace(regexChar, function (n) { return htmlEntitiesChar[n] })
                line = line.replace(regexAmpersan, function (n) { return htmlEntitiesAmp[n] })
                line = line.replace(regexHexaChar, function (n) { return hexaChar[n] })
    ...
    log = log.replace(regexChar, function (n) { return htmlEntitiesChar[n] })
    log = log.replace(regexAmpersan, function (n) { return htmlEntitiesAmp[n] })
    log = log.replace(regexHexaChar, function (n) { return hexaChar[n] })
